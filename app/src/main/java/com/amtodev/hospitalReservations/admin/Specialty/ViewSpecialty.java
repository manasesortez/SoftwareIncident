...
public class ViewSpecialty extends AppCompatActivity {
    ...
    public ArrayList llenarLista(){
        ...
        try{
            ...
            String consulta = "SELECT especialidad_id,especialidad_nombre FROM especialidades ORDER BY especialidad_nombre ASC";
    ...
    public void exportarPDF() throws FileNotFoundException {
        try {
            ...
            String comando = "SELECT especialidad_id,especialidad_nombre FROM especialidades ORDER BY especialidad_nombre ASC";
